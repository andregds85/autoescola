...
<form method="POST" action="{{route('categorias.editar', $item)}}">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    <label for="exampleInputEmail1">Cnes</label>
                    <input value="{{$item->cnes}}" type="text" class="form-control" id="" name="cnes" required>
                </div>
            </div>

            <input value="{{$item->cnes}}" type="hidden"  name="old">
